...
export default function Login(props) {
  ...
  const userLogin = async (e) => {
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        props.setUser({ name: data.data.user.name, email: data.data.user.email })
  ...
  if (newUser) {
    return <div>
      ...
      <CreateUser newUser={newUser} setNewUser={setNewUser} user={props.user} setUser={props.setUser} />
    </div>
  }
  ...
  return (<div>
    ...
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate onSubmit={(e) => { userLogin(e) }}>
          <TextField
            variant="outlined"
            margin="normal"
            required
          ...
          <Grid container>
            ...
            <Grid item>
              <Link href="/sign-up" variant="body2" onClick={() => setNewUser(!newUser)}>
